...
public interface HouseDao {
	...
	public int addHouseDeal(String dong, String aptName, int code, String dealAmount, int buildYear, int dealYear, int dealMonth, int dealDay,
			double area, int floor, String jibun, String type, String rentMoney) throws SQLException;
